...
-- Problem 26
SELECT givenname, surname, SUM(order_total), SUM(order_total)*.15 FROM salespeople LEFT JOIN orders ON (salespeople.id=salesperson_id) GROUP BY salespeople.id; 
